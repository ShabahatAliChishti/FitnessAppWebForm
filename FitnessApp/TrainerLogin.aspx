<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TrainerLogin.aspx.cs" Inherits="FitnessApp.TrainerLogin" %>
  ...
  <body style="background-image: url(../build/images/backgrounds/16.jpg)" class="body-bg-full">
    <div class="container page-container">
      <div class="page-content">
        ...
        <form class="form-horizontal" runat="server" >
          <div class="form-group">
            <div class="col-xs-12">
              <input type="text" name="txtusername" id="txtusername" value="" placeholder="Username" class="form-control" runat="server">
     ...
     <%--     <div class="form-group">
          ...
          <asp:Button ID="btntrainerlogin" class="btn-lg btn btn-primary btn-rounded btn-block" runat="server" Text="Sign In" OnClick="btntrainerlogin_Click" />

        </form>
        <hr>
        <p class="text-muted">Sign In As Trainer</p>
 <%--       <div class="clearfix">
          <div class="pull-left">
        ...
        <hr>
        <div class="clearfix">
         <a href="TrainerSignUp.aspx" class="text-muted mb-0 pull-left">Want new account</a>
        </div>
      </div>
    </div>
    <!-- Demo Settings start-->
