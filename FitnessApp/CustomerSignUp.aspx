<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CustomerSignUp.aspx.cs" Inherits="FitnessApp.CustomerSignUp" %>
          ...
          <div class="form-group">
            ...
            <div class="col-xs-12">
              <input type="text" name="txtusername" id="txtusername" value="" placeholder="User Name" class="form-control" runat="server">
                <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ErrorMessage="Enter User Name" ForeColor="Red" ControlToValidate="txtusername"></asp:RequiredFieldValidator>
            </div>
          </div>
                  <div class="form-group">
            <div class="col-xs-12">
              <input type="password" name="txtpassword" id="txtpassword" value="" placeholder="Password" class="form-control" runat="server">
                <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ErrorMessage="Enter Password" ForeColor="Red" ControlToValidate="txtpassword"></asp:RequiredFieldValidator>
            </div>
          </div>
     <%--     <div class="form-group">
            <div class="col-xs-12">
            ...
            <asp:Button ID="btncusacc" class="btn-lg btn btn-primary btn-rounded btn-block" runat="server" Text="Create Account" OnClick="btncusacc_Click" />
