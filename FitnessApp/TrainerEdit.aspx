<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TrainerEdit.aspx.cs" Inherits="FitnessApp.TrainerEdit" %>
  ...
  <body data-sidebar-color="sidebar-light" class="sidebar-light">
    ...
    <!-- Demo Settings end-->
         ...
         <div class="page-content container-fluid">
          <div class="row">
            <div class="col-md-6" style="margin-left: 236px;">
              <div class="widget">
                <div class="widget-heading">
                  <h3 class="widget-title">Trainer Form</h3>
                </div>
                  ...
                  <form runat="server">
                    ...
                    <div class="form-group">
                      ...
                      <%--<input id="txtlastname" type="text" class="form-control" runat="server">--%>
                         ...
                         <div class="form-group">
                      <label for="textInput">Mobile No</label>
                       <asp:TextBox ID="txtmobileno" class="form-control" runat="server"></asp:TextBox>
                      <%--<input id="txtmobileno" type="text" class="form-control" runat="server">--%>
                    </div>
                    <div class="form-group">
                      <label for="textInput">Address</label>
                    <asp:TextBox ID="txtaddress" class="form-control" runat="server"></asp:TextBox>
                      <%--<input id="txtaddress" type="text" class="form-control" runat="server">--%>
                    </div>
                         <div class="form-group">
                      <label for="passwordInput">Expertise</label>
                      <asp:TextBox ID="txtexpertise" class="form-control" runat="server"></asp:TextBox>
                      <%--<input id="txtexpertise" type="text" class="form-control" runat="server">--%>
                    </div>
                      <asp:Button ID="btnsubmit" runat="server" Text="Update" class="btn-lg btn btn-primary btn-rounded btn-block" OnClick="btnsubmit_Click"/>
                  </form>
                </div>
              </div>
            </div>
