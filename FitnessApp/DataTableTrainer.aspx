<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DataTableTrainer.aspx.cs" Inherits="FitnessApp.DataTableTrainer" %>
  ...
  <body data-sidebar-color="sidebar-light" class="sidebar-light">
    ...
    <header>
      ...
      <%--      <li><a href="profile.html"><i class="ti-user mr-5"></i> My Profile</a></li>
            ...
            <li><<a href="TrainerLogin.aspx?action=logout"><i class="ti-power-off mr-5"></i> Logout</a></li>
          </ul>
        </li>
      </ul>
    </header>
    ...
    <!-- Demo Settings end-->
      ...
      <form runat="server">
    <%--<asp:Label ID="Label1" runat="server" Text="Search" style="margin-left: 273px;"></asp:Label><asp:TextBox ID="SearchTextBox" runat="server" style="margin-left: 15px;margin-top: 25px;" AutoPostBack="True" OnTextChanged="SearchTextBox_TextChanged"></asp:TextBox>--%>
    <div>
        <asp:GridView ID="GridView1" runat="server" style="margin-left: 253px;width: 82%;margin-top: 34px;" CssClass="table table-bordered">
        </asp:GridView>
    </div>
    <div>
        <asp:Button ID="btnedit" runat="server" Text="Edit" class="btn-lg btn btn-primary btn-rounded btn-block" style="width:7%;margin-left: 264px;" OnClick="btnedit_Click"/><asp:Button ID="btndelete" class="btn-lg btn btn-danger btn-rounded btn-block" runat="server" Text="Delete" style="width:7%;margin-left: 374px;margin-top: -41px;" OnClick="btndelete_Click"/>
    </div>
</form>
    <!-- jQuery-->
...
<body>
<form runat="server">
    <asp:Label ID="Label1" runat="server" Text="Search"></asp:Label>&nbsp;&nbsp;&nbsp;<asp:TextBox ID="SearchTextBox" runat="server" AutoPostBack="True" OnTextChanged="SearchTextBox_TextChanged"></asp:TextBox>
    <div>
